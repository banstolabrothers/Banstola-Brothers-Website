...
export const metadata: Metadata = {
  ...
  description:
    "Buy authentic handcrafted chhurpi (churpi) from Banstola Brothers. Smoked, White & Coffee Chhurpi sourced from Ilam, Dolakha & Palpa, plus khattu and titaura (paun). Shop in Pokhara, Nepal — delivery to Kathmandu and nationwide.",
  keywords: [
    "Churpi Pokhara",
    "Churpi Pokhara",
    "Banstola Brothers",
